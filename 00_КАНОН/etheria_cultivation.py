...
chk('C-24 демон нижний: канон §2.4 14 эф.мес = 420 эф. дн (χ-кристаллизация скелета плода)',
    GEST['Демон нижний']['canon_ef_days'], 420, tol=0.0)
chk('C-25 Повелитель: канон §2.5 18 эф.мес = 540 эф. дн (χ + фазовая стабилизация)',
...
chk('C-27 эльф: канон §2.7 10 эф.мес = 300 эф. дн — базовый вид 52 кг (северный подтип вне базы)',
...
VERDICT_GEST = dict(
    ...
    rationale=['A калибрована бит-в-бит по канону H.e. (276 эф. дн = 9.2 эф. мес; R-скрипт 9.2×30)',
               'эльф: канон §2.7 10 мес = 300 эф. дн vs A(52 кг) = 301.5 → Δ0.5% (базовый вид, GEOGRAPHY 10.5)',
               'межрасовый размах A: 237.5 (гоблин) → 363.7 (Повелитель) эф. дн — физиологично для углеродных'],
    flags=['ОРК/ГОБЛИН: канон 8/6 мес = 240/180 эф. дн — осознанные r-отклонения («боевая»/«r-стратегия»), '
           ...
           'утробы), но механизм развития плода = χ-КРИСТАЛЛИЗАЦИЯ СКЕЛЕТА (§2.4: 14 эф.мес = 420 эф. дн = '
           '326.7 зем. дн; Повелитель §2.5: 18 мес = 540 эф. дн + фазовая стабилизация); зрелость ~50 '
