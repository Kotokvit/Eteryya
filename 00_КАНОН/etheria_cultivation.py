...
VERDICT_GEST = dict(
    ...
    flags=['ЭЛЬФ: канон Бестиария §2.7 = 10 мес (304.4 д) vs модель A(52 кг) = 305.9 д → Δ0.5% ✓ — '
           'см. ELF_PHYSIOLOGY.json (ratio-тест); северный компактный подтип (28 кг) → A = 262 д, канона НЕТ — ВОПРОС АВТОРУ',
