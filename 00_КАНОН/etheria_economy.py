...
chk('E-14 продспрос 39.6 млн т/год (аксиома-география)', round(FOOD/1e6, 1), 39.6, 0.1)
# фрахт продовольствия: 39.6 млн т × средний тариф каравана × среднее плечо 1500 км
