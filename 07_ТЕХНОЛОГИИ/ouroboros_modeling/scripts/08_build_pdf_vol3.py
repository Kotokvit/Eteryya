...
P(story, "Первый контур модуля — проверка четырех канонических законов против "
   "независимых формул. Плотность ф-конденсата в тканях вычисляется по "
...
P(story, "Второй контур модуля — регрессионный анализ канонических шкал "
   "долголетия и регенерации по плотности ф-конденсата. Для углеродных рас "
...
FINAL = "/home/vitalij/Стільниця/Eteryya/07_ТЕХНОЛОГИИ/ouroboros_modeling/Система_Уроборос_Том3_Биологическое_железо.pdf"
os.makedirs(os.path.dirname(FINAL), exist_ok=True)
writer = PdfWriter()
cov_file = os.path.join(HERE, "cover3.pdf")
if not os.path.exists(cov_file):
    cov_file = os.path.join(os.path.dirname(HERE), "cover3.pdf")
